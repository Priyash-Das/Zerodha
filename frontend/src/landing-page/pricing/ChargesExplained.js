  ...
  return (
    <div className="container">
      <div className="row px-5 pb-3">
        ...
        <div className="col-6 text-muted mt-5">
          <h1 className="fs-5 mb-3">Securities/Commodities transaction tax</h1>
          <p className="pe-5" style={{ fontSize: "13px" }}>
          ...
          <h1 className="fs-5 mb-3">Transaction/Turnover Charges</h1>
          <p className="pe-5" style={{ fontSize: "13px" }}>
          ...
          <h1 className="fs-5 mb-3">Call & trade</h1>
          <p className="pe-5" style={{ fontSize: "13px" }}>
            Additional charges of ₹50 per order for orders placed through a
            dealer at Zerodha including auto square off orders.
          </p>
          <h1 className="fs-5 mb-3">Stamp charges</h1>
          <p className="pe-5" style={{ fontSize: "13px" }}>
          ...
          <h1 className="fs-5 mb-3">NRI brokerage charges</h1>
          <p className="pe-5 mb-1" style={{ fontSize: "13px" }}>
          ...
          <h1 className="fs-5 mb-3">Account with debit balance</h1>
          <p className="pe-5" style={{ fontSize: "13px" }}>
          ...
          <h1 className="fs-5 mb-3">Margin Trading Facility (MTF)</h1>
          <p className="pe-5 mb-1" style={{ fontSize: "13px" }}>
        ...
        <div className="col-6 text-muted mt-5">
          <h1 className="fs-5 mb-3 ps-5">GST</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
            Tax levied by the government on the services rendered. 18% of (
            brokerage + SEBI charges + transaction charges)
          </p>
          <h1 className="fs-5 mb-3 ps-5">SEBI Charges</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
            Charged at ₹10 per crore + GST by Securities and Exchange Board of
            India for regulating the markets.
          </p>
          <h1 className="fs-5 mb-3 ps-5">
          ...
          <h1 className="fs-5 mb-3 ps-5">Pledging charges</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
            ₹30 + GST per pledge request per ISIN.
          </p>
          <h1 className="fs-5 mb-3 ps-5">AMC (Account maintenance charges)</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
          ...
          <h1 className="fs-5 mb-3 ps-5">Corporate action order charges</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
            ₹20 plus GST will be charged for OFS / buyback / takeover /
            delisting orders placed through Console.
          </p>
          <h1 className="fs-5 mb-3 ps-5">Off-market transfer charges</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
            ₹25 per transaction.
          </p>
          <h1 className="fs-5 mb-3 ps-5">Physical CMR request</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
            First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST for
            subsequent requests.
          </p>
          <h1 className="fs-5 mb-3 ps-5">Payment gateway charges</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
            ₹9 + GST (Not levied on transfers done via UPI)
          </p>
          <h1 className="fs-5 mb-3 ps-5">Delayed Payment Charges</h1>
          <p className="ps-5" style={{ fontSize: "13px" }}>
          ...
          <p className="ps-5 mb-1" style={{ fontSize: "13px" }}>
      ...
      <div className="text-muted pb-4">
        <h1 className="fs-5 mb-3 px-5">Disclaimer</h1>
        <p className="px-5 pb-5" style={{ fontSize: "13px" }}>
